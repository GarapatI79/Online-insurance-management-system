    ...
    <a href="index.php"><h2><img src="logo.png" style="width:150px"> Life Insurance Corporation</h2></a>
		...
		<div class = "container" style="padding-left: 0px">
 		   ...
 		   <th>Premium Data - Reciept Generation </th><th></th>   
                    ...
                    <tr><td><label style="font-weight: bold;font-size: 20px;">Premium payed?: </label> </td><td>  <p style="font-family:cursive"> 
                    <input type = "radio"  name = "pay" value = "Yes" required />Yes
					<input type = "radio" name = "pay" value = "No" required />No</p>
					<br></td></tr>
				 </table>
